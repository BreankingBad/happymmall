/*
* @Author: mxm
* @Date:   2018-02-03 11:23:47
* @Last Modified by:   mxm
* @Last Modified time: 2018-02-03 12:50:58
*/
'use strict';
require('./index.css');
...
var _address = require('serviceDir/address-service.js');
...
var page = {
    ...
    loadAddressList : function () {
        ...
        _address.getAddressList(function (res) {
            ...
            var addressListHtml = utils.renderHtml(templateAddress,res);
    ...
    loadProductList : function () {
        ...
        _order.getProductList(function (res) {
            var productListHtml = utils.renderHtml(templateProduct,res);
